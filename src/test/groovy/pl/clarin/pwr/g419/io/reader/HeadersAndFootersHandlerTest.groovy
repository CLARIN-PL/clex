...
class HeadersAndFootersHandlerTest extends Specification {
    ...
    def "364141 - HeadersAndFootersHandlerTest should construct valid headers and footers"() {
        ...
        // TODO :
//        dane dla parametru FOCUS = 1.0/1.8
//
//        footers.size() == 8
//        footers[0].startIndex == 0
//        footers[0].endIndex == 0
//        footers[0].level == 0
//        footers[0].lines[0].text == "Poziom zaokrągleń : wszystkie kwoty wyrażone są w tysiącach złotych polskich (o ile nie wskazano inaczej ) "
//
//        footers[1].startIndex == 1
//        footers[1].endIndex == 4
//        footers[1].level == 1
//        footers[1].lines[0].text == "Poziom zaokrągleń : wszystkie kwoty wyrażone są w tysiącach złotych polskich (o ile nie wskazano inaczej ) "
//        footers[1].lines[1].text == "Okres objęty spra wozda niem finansowym : 01.01.2017 – 30 .06.2017 Waluta sprawozdawcza : złoty polski (PLN ) "
//
//        footers[2].startIndex == 5
//        footers[2].endIndex == 7
//        footers[2].level == 1
//        footers[2].lines[0].text == "Poziom zaokrągleń : wszystkie kwoty wyrażone są w tysiącach złotych polskich (o ile nie wskazano inaczej ) "
//        footers[2].lines[1].text == "Okres objęty spra wozda niem finansowym : 01.01.2017 – 30.06 .2017 Waluta sprawozdawcza : złoty polski (PLN ) "
//
//        footers[3].startIndex == 8
//        footers[3].endIndex == 17
//        footers[3].level == 1
//        footers[3].lines[0].text == "Poziom zaokrągleń : wszystkie kwoty wyrażone są w tysiącach złotych polskich (o ile nie wskazano inaczej ) "
//        footers[3].lines[1].text == "Okres objęty spra wozda niem finansowym : 01.01.2017 – 30 .06.2017 Waluta sprawozdawcza : złoty polski (PLN ) "
//
//        footers[4].startIndex == 18
//        footers[4].endIndex == 19
//        footers[4].level == 0
//        footers[4].lines[0].text == "Poziom zaokrągleń : wszystkie kwoty wyrażone są w tysiącach złotych polskich (o ile nie wskazano inaczej ) "
//
//        footers[5].startIndex == 20
//        footers[5].endIndex == 33
//        footers[5].level == 1
//        footers[5].lines[0].text == "Poziom zaokrągleń : wszystkie kwoty wyrażone są w tysiącach złotych polskich (o ile nie wskazano inaczej ) "
//        footers[5].lines[1].text == "Okres objęty spra wozda niem finansowym : 01.01.2017 – 30 .06.2017 Waluta sprawozdawcza : złoty polski (PLN ) "
//
//        footers[6].startIndex == 34
//        footers[6].endIndex == 34
//        footers[6].level == 0
//        footers[6].lines[0].text == "Poziom zaokrągleń : wszystkie kwoty wyrażone są w tysiącach złotych polskich (o ile nie wskazano inaczej ) "
//
//        footers[7].startIndex == 35
//        footers[7].endIndex == 48
//        footers[7].level == 1
//        footers[7].lines[0].text == "Poziom zaokrągleń : wszystkie kwoty wyrażone są w tysiącach złotych polskich (o ile nie wskazano inaczej ) "
//        footers[7].lines[1].text == "Okres objęty spra wozda niem finansowym : 01.01.2017 – 30 .06.2017 Waluta sprawozdawcza : złoty polski (PLN ) "
